...
@Component({
  selector: 'app-stats-area-chart',
  templateUrl: './stats-area-chart.component.html',
  styleUrls: ['./stats-area-chart.component.scss']
})
export class StatsAreaChartComponent implements OnInit, AfterViewInit, OnDestroy {
